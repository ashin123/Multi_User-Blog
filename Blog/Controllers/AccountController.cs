        ...
        public ActionResult RegisterAjax()
        {
            try
            {
                ...
                if (verifycode.ToUpper() == vc.ToUpper())
                {
                    ...
                    sb.Append(string.Format(@"<span>恭喜您，已成功注册为zhuankeshumo微博客的会员。</span><br/>
                    ...
                    sb.Append("<span><a href=\"mailto:web@blog.com\">web@blog.com</a></span><br/><br/>");

                    sb.Append(@"<span>再次感谢您对zhuankeshumo微博客的支持与关注，祝你每一天都有收获！</span><br/>
                        <br/>
                        <span>============================================================================================</span><br/>
                        <br/>
                    ...
                    {
                        Common.SendEmail.SendMails(user.Email, "zhuankeshumo微博客注册帐号激活", sb.ToString(),
                            () =>
                            {
